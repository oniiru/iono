...
class categoriesVideo {
	...
	function categoriesVideo() {
		...
		//Apply stylesheets properly - through a hook
		add_action('init', array($this, 'enquequeAllStyles'));
	}
	
	/**
	 * Applies sequence of queued stylesheets
	 */
	function enquequeAllStyles(){
...
<div id="incontent">
<div id="tophead">
<h2 class="categoryTitle">Courses</h2>
<div id="searchlib">
<form name="slib" action="" >
<input value="' . $search . '" id="ss" name="keyword"><input type="submit" name="submit" class="blue catbutton" value="search">
</form>
</div>
</div>';
		if (!is_user_logged_in()) {
			$str.='<div class="warringup"><h3>New to SolidWize? Click on any of the links below to try a few of our free videos.</h3><p>Ready to pull the trigger and become a SolidWorks badass? <a href="http://solidwize.com/pricing-2" class="large red catbutton" title="Sign Up">Sign Up Now</a> </p></div>';
		}
