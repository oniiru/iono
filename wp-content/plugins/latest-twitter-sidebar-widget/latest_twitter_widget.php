...
<?php
	...
	function widget($args, $instance) {
		...
		if( $haveTwitterData ){
			$linkHTML = "<a href=\"https://twitter.com/".$username."\">";
	...
	function fix_twitter_update($origTweet,$entities) {
		...
		foreach( $entities->hashtags as $hashtag ){
			$index[$hashtag->indices[0]] = "<a href=\"https://twitter.com/#!/search?q=%23".$hashtag->text."\">#".$hashtag->text."</a>";
			$endEntity[$hashtag->indices[0]] = $hashtag->indices[1];
		}
		foreach( $entities->user_mentions as $user_mention ){
			$index[$user_mention->indices[0]] = "<a href=\"https://twitter.com/".$user_mention->screen_name."\">@".$user_mention->screen_name."</a>";
