				...
				<div id="et_pt_portfolio_gallery" class="clearfix<?php echo $et_ptemplate_portfolio_class; ?>">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
						...
						if ( has_post_thumbnail( $post->ID ) && $et_ptemplate_detect_portrait ) {
							...
							if ( $et_auto_image_detection && et_is_portrait($wordpress_thumbnail_url,$ignore_cfields = true) ) {
								$height = $et_portrait_height;
							}
						}
						...
						if ( $thumbnail["use_timthumb"] && et_is_portrait($thumb,$et_auto_image_detection) && $et_ptemplate_detect_portrait ) {
							...
							else if ( $et_auto_image_detection && et_is_portrait($thumb, $ignore_cfields = true) ) $height = $et_portrait_height;
						} ?>
								...
								<div class="et_pt_portfolio_item">
									...
									<div class="et_pt_portfolio_entry<?php if ( $height == $et_portrait_height ) echo ' et_portrait_layout'; ?>">
										<div class="et_pt_portfolio_image<?php if ($et_videolink <> '') echo ' et_video'; ?>">
											...
											<a class="et_portfolio_zoom_icon" title="<?php the_title(); ?>" rel="prettyPhoto[portfolio]" href="<?php if ($et_videolink <> '') echo $et_videolink; else echo($thumbnail['fullpath']); ?>"><?php _e('Zoom in','Envisioned'); ?></a>
											<a class="et_portfolio_more_icon" href="<?php the_permalink(); ?>"><?php _e('Read more','Envisioned'); ?></a>
