...
<!--[if lt IE 7]>
	...
	<script type="text/javascript">DD_belatedPNG.fix('img#logo, #search-form, span.overlay, a.zoom-icon, a.more-icon, #menu, #menu-right, #menu-content, ul#top-menu ul, #featured a#left-arrow, #featured a#right-arrow, #top-bottom, #top .container, #recent-projects, #recent-projects-right, #recent-projects-content, .project-overlay, span#down-arrow, #footer-content, #footer-top, .footer-widget ul li, span.post-overlay, #content-area, .avatar-overlay, .comment-arrow');</script>
<![endif]-->
<!--[if IE 7]>
		...
		<div id="top-wrapper">
			<div id="top-content">
				<div id="bottom-light">
								...
								<div id="menu-content">
									...
									if ($primaryNav == '') { ?>
										<ul id="<?php echo $menuID; ?>" class="<?php echo $menuClass; ?>">
											<?php if (get_option('envisioned_home_link') == 'on') { ?>
												<li <?php if (is_home()) echo('class="current_page_item"') ?>><a href="<?php bloginfo('url'); ?>"><?php _e('Home','Envisioned') ?></a></li>
											<?php }; ?>
									...
									<div id="social-icons">
										<?php 
											...
											if ( get_option('envisioned_show_rss_icon') == 'on' ) $social_icons['rss'] = array('image' => get_bloginfo('template_directory') . '/images/youtube.png', 'url' => $et_rss_url, 'alt' => 'Rss' );
									...
									<div id="search-form">
											<form method="get" id="searchform" action="<?php bloginfo('url'); ?>">
												<input type="text" value="<?php _e('search this site...','Envisioned'); ?>" onclick="this.value=''" name="s" id="searchinput" />
					...
					<?php if ( is_home() && get_option('envisioned_featured') == 'on' ) include(TEMPLATEPATH . '/includes/featured.php'); ?>					
