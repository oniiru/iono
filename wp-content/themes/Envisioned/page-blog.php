				...
				<div id="et_pt_blog">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
						...
						<div class="et_pt_blogentry clearfix">
							...
							<p class="et_pt_blogmeta"><?php _e('Posted','Envisioned'); ?> <?php _e('by','Envisioned'); ?> <?php the_author_posts_link(); ?> <?php _e('on','Envisioned'); ?> <?php the_time(get_option('envisioned_date_format')) ?> <?php _e('in','Envisioned'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(__('0 comments','Envisioned'), __('1 comment','Envisioned'), '% '.__('comments','Envisioned')); ?></p>
